...
namespace Automobile_Company.ViewModels
{
    public class EditOrderViewModel : INotifyPropertyChanged
    {
        ...
        private ObservableCollection<CargoItem> _items;
        ...
        public ObservableCollection<CargoItem> Items
        {
            get => _items;
            set
            {
        ...
        public double TotalWeight => Items?.Sum(item => item.TotalWeight) ?? 0;
        public decimal TotalInsuranceValue => Items?.Sum(item => item.InsuranceValue) ?? 0;
        ...
        private void InitializeFromOrder()
        {
            ...
            foreach(var a in _order.CargoItems)
            {
                Items.Add(a);
            }
        ...
        private void RemoveCargoItem(object parameter)
        {
            ...
            {
                Items.Remove(SelectedCargoItem);
